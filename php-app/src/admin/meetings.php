...
<html lang="en">
   ...
   <body>
      <div class="container-fluid position-relative bg-white d-flex p-0">
         ...
         <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
               ...
               <div class="navbar-nav w-100">
                  ...
                  <a href="meetings.php" class="nav-item nav-link active"><i class="fa fa-calendar-alt"></i><b> Meetings</b></a>
               ...
               <div class="row g-4">
                  <div class="col-12">
                     <div class="echo-table rounded h-100 p-4">
                        <h4 class="mb-4 echo-text">Scheduled Meetings</h4>
                           ...
                           <table class="table table-bordered">
                              ...
                              <tbody class="text-light">
                                 ...
                                 <tr>
                                    ...
                                    <td><?= $row['message'] ?></td>
                                    <td>
                                       <button class="btn btn-sm btn-danger deleteMeeting" data-id="<?= $row['id'] ?>">
         ...
         <!-- Content End -->
         <script>
            document.querySelectorAll('.deleteMeeting').forEach(btn => {
                btn.addEventListener('click', function(){
                    if(confirm('Are you sure to delete?')){
                        fetch('delete_meeting.php?id=' + this.dataset.id)
                        .then(res => res.text())
