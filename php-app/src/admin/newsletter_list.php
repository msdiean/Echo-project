<?php
   ...
   if(isset($_GET['delete_id'])){
       ...
       $conn->query("DELETE FROM newsletter WHERE id=$delete_id");
       header("Location: newsletter_list.php");
       exit;
   }
   
   
   $result = $conn->query("SELECT * FROM newsletter ORDER BY created_at ASC");
   ?>
<!DOCTYPE html>
<html lang="en">
   <head>
      <meta charset="utf-8">
      <title>Echo Newsletter</title>
         ...
         <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
               ...
               <div class="navbar-nav w-100">
                  ...
                  <a href="newsletter_list.php" class="nav-item nav-link active"><i class="fa fa-envelope"></i><b> Newsletter</b></a>
               ...
               <div class="row g-4">
                  <div class="col-12">
                     <div class="echo-table rounded h-100 p-4">
                        <h4 class="mb-4 echo-text">Subscribed Newsletters</h4>
